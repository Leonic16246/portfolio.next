      ...
      <div className="bg-white dark:bg-neutral-800 rounded-lg px-6 py-8 ring-1 ring-neutral-900/5 dark:ring-neutral-700/50 shadow-xl ">
        <div className='flex justify-between'>
          ...
          <div className="">
            ...
            <h3 className="mt-2 text-2xl text-neutral-600 dark:text-neutral-200">A software engineering student</h3>
            <h4 className="mt-2 text-xl text-neutral-600 dark:text-neutral-200">Welcome to my portfolio</h4>
          </div>
